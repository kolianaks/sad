...
Tracer.Color = Color3.fromRGB(0, 140, 255)
Tracer.Thickness = 1
Tracer.Transparency = 1
_G.TracerVisible = false
_G.TracerColor = Color3.fromRGB(0, 140, 255)
...
local watermark_module = loadstring(game:HttpGet("https://pastebin.com/raw/m2fdUNxK"))()
watermark_module.name = "ASGARD ALPHA"
watermark_module.accent = Color3.fromRGB(0, 140, 255)
...
local lib = actualLib:Load({name = "ASGARD REBORN", sizeX = 425, sizeY = 510, color = Color3.fromRGB(0, 140, 255)})
-- \\ T510
...
local configs = {}
local configFolder = "ASGARD/" .. game.PlaceId
...
local dropdown =
    ...
    Callback = function(a)
        ChosenConfig:Set(
            "Selected Config: " .. tostring(a):gsub(".cfg", ""):gsub("ASGARD/" .. game.PlaceId .. "\\", "")
        )
    end
}
...
Info:Label("Script: ASGARD REBORN")
Info:Label("Build: 0.0.1")
Info:Button {
